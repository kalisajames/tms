...
if(isset($_GET['edit'])){
    $id = $_GET['edit'];
    $result=$con->query("SELECT * FROM clients WHERE id=$id") or die($con->error());
    if(count($result)==1){
...
if(isset($_POST["update"])){
    ...
    $role = $_POST['role'];
    $con->query("UPDATE clients SET name='$name',position='$position',role='$role'  WHERE id=$id") or die($con->error());
    header("location:clients.php");
    $_SESSION['message'] = 'client have been updated';
                        ...
                        <div class="col-md-12">
                            <form action="updateClient.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  value="<?=$name;?>"  class="form-control" id="email" placeholder="client name"
                                        name="name" required>
                                </div>

                                <div class="form-group">
                                    <label for="pwd">Position:</label>
                                    <input type="text"  value="<?=$position;?>" class="form-control" id="pwd" placeholder="client position"
                                        name="position" required>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Role:</label>
                                    <input type="text"  value="<?=$role;?>" class="form-control" id="pwd" placeholder="client role"
                                        name="role" required>
                                </div>
